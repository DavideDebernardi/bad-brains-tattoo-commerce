...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "variants_rels" ADD CONSTRAINT "variants_rels_parent_1_idx" FOREIGN KEY ("parent_id") REFERENCES "public"."variants"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_variants_v_rels" ADD CONSTRAINT "_variants_v_rels_parent_1_idx" FOREIGN KEY ("parent_id") REFERENCES "public"."_variants_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products_rels" ADD CONSTRAINT "products_rels_parent_1_idx" FOREIGN KEY ("parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_rels" ADD CONSTRAINT "_products_v_rels_parent_1_idx" FOREIGN KEY ("parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "orders_rels" ADD CONSTRAINT "orders_rels_parent_1_idx" FOREIGN KEY ("parent_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
